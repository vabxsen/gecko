package com.orca.feature.settings.about
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(innerPadding)) {
            Column(
                ...
                Text(text = "Orca", style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.SemiBold)
                Text(
            ...
            SettingsRow(
                ...
                subtitle = "Orca talks directly to OpenAI, Anthropic, Google, and OpenRouter using API keys you provide. There is no Orca backend, and your conversations never pass through a third-party server.",
            )
            SettingsRow(
